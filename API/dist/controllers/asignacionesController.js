...
//     Asignaciones.create(nuevaAsignacion);
...
//     Asignaciones.delete(darDeBajaAsignacion);
...
//         return res.status(404).json(asignacionView.errorAsignacion('Asignación no encontrada'));
//     }
//     Asignaciones.read(obtenerDetallesAsignacion);
...
//     Asignaciones.create(registroAsignacionesPorArticulo);
//     res.json(asignacionView.listaAsignaciones(resultado));
// };
...
//     Asignaciones.create(registroAsignacionesPorResponsable);
//     res.json(asignacionView.listaAsignaciones(resultado));
// };
