  ...
  return (
    ...
    <Router>
      <Routes>
          ...
          <Route path="/articles/detalles/:no_inventario" element={<Aut children={<Page.Articles.information />} />} />
          ...
          <Route path="/groups" element={<Aut children={<Page.Groups.panel />} />} />
          <Route path="/groups/edit/:pk" element={<Aut children={<Page.Groups.edit />} />} />
          <Route path="/groups/information/:pk" element={<Aut children={<Page.Groups.information />} />} />
          <Route path="/groups/load" element={<Aut children={<Page.Groups.load />} />} />
          <Route path="/groups/removal/:pk" element={<Aut children={<Page.Groups.removal />} />} />
